...
from Levenshtein import jaro as Distance_jaro

# Give the location of the file 
loc= ("C:/Users/Admin/Desktop/unimas_kursus/test_malay.xlsx")

result=open("result_malay_jaro.txt","w")
...
def cal_distance_edit(rows):
    ...
    for x in range(1,11):
        ...
        if (isinstance(sheet.cell_value(rows,x),str)):
            ...
            print(Distance_jaro(sheet.cell_value(rows,x),text1[x-1]))
            result.write(str(Distance_jaro(sheet.cell_value(rows,x),text1[x-1]))+" ")
